    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_type', models.CharField(default=b'', max_length=10, verbose_name='\u8fd4\u56de\u503c\u7c7b\u578b', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'list_json': ['content', 'user_id', 'id', 'api_id', 'user__realname', 'user__icon_url', 'to_user__realname', 'to_user__icon_url', 'create_time', 'to_comment_id', 'to_comment__content', 'to_comment__user_id', 'to_comment__user__icon_url', 'to_comment__user__realname', 'source', 'username'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.CharField(max_length=30, null=True, verbose_name='\u53c2\u6570\u9ed8\u8ba4\u503c')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('namespace', models.CharField(db_index=True, max_length=20, verbose_name='\u6a21\u5757\u540d', blank=True)),
            ],
            options={
