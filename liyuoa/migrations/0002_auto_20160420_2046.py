...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='appapireplay',
            name='to_replay',
            field=models.ForeignKey(verbose_name='\u7236\u7ea7\u8bc4\u8bba', to='liyuoa.AppApiReplay', null=True),
        ),
        migrations.AddField(
            model_name='appapireplay',
            name='to_user',
            field=models.ForeignKey(related_name='api_to_replay', verbose_name='\u96b6\u5c5e\u7528\u6237', to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='appapireplay',
            name='user',
